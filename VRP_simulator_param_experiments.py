...
# Se crean las 108 instancias para los experimentos, un Proceso y objetos de los Algoritmos de resolución (CI y OPMC)
...
if args['num_exp'] == 0:
    ...
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0)
    results = open('param results 0 0_001 10000.txt', 'w')
if args['num_exp'] == 1:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    ...
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=1/1000)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.01)
    results = open('param results 0_01 0_001 10000.txt', 'w')
if args['num_exp'] == 2:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    ...
    results = open('param results 0_05 0_001 10000.txt', 'w')
if args['num_exp'] == 3:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    ...
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=1/1000)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.1)
    results = open('param results 0_1 0_001 10000.txt', 'w')
if args['num_exp'] == 4:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    ...
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=1/1000)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.15)
    results = open('param results 0_15 0_001 10000.txt', 'w')
if args['num_exp'] == 5:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    ...
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=1/1000)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.2)
    results = open('param results 0_2 0_001 10000.txt', 'w')
if args['num_exp'] == 6:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    ...
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=1/1000)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.25)
    results = open('param results 0_25 0_001 10000.txt', 'w')
if args['num_exp'] == 7:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    mc_initial_value_function = ValueFunction()
    # se inicializa RLS para la aproximación de la value function
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=1/100)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.05)
    results = open('param results 0_05 0_01 10000.txt', 'w')
if args['num_exp'] == 8:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    mc_initial_value_function = ValueFunction()
    # se inicializa RLS para la aproximación de la value function
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=1/10)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.05)
    results = open('param results 0_05 0_1 10000.txt', 'w')
if args['num_exp'] == 9:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    mc_initial_value_function = ValueFunction()
    # se inicializa RLS para la aproximación de la value function
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=1)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.05)
    results = open('param results 0_05 1 10000.txt', 'w')
if args['num_exp'] == 10:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    ...
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.05)
    results = open('param results 0_05 100 10000.txt', 'w')
if args['num_exp'] == 11:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    ...
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.05)
    results = open('param results 0_05 1000 10000.txt', 'w')
if args['num_exp'] == 12:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    mc_initial_value_function = ValueFunction()
    # se inicializa RLS para la aproximación de la value function
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=10000)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.05)
    results = open('param results 0_05 10000 10000.txt', 'w')
if args['num_exp'] == 13:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    mc_initial_value_function = ValueFunction()
    # se inicializa RLS para la aproximación de la value function
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=100000)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.05)
    results = open('param results 0_05 100000 10000.txt', 'w')
if args['num_exp'] == 14:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=10000, simulation_seed=9)
    # se crea una instancia de value function
    mc_initial_value_function = ValueFunction()
    # se inicializa RLS para la aproximación de la value function
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=1000000)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.05)
    results = open('param results 0_05 1000000 10000.txt', 'w')
if args['num_exp'] == 15:
    # se crean las realizaciones de entrenamiento para el algoritmo
    ...
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.05)
    results = open('param results 0_05 0_001 5000.txt', 'w')
if args['num_exp'] == 16:
    # se crean las realizaciones de entrenamiento para el algoritmo
    monte_carlo.simulateTrainRealizations(N=15000, simulation_seed=9)
    # se crea una instancia de value function
    mc_initial_value_function = ValueFunction()
    # se inicializa RLS para la aproximación de la value function
    mc_initial_value_function.initializeRecursiveLeastSquares(lambd=1/1000)
    # entrenando el modelo con el método que utiliza RLS
    mc_trained_value_function, mc_train_historic_weights, mc_train_rewards, mc_train_penalties, mc_train_ndelays, mc_train_delays, mc_train_nrejects, mc_mape_list, mc_mse_list = monte_carlo.train(mc_initial_value_function, epsilon=0.05)
    results = open('param results 0_05 0_001 15000.txt', 'w')
...
if args['num_exp']== 0:
    fig_error.savefig('param error results 0 0_001 10000.jpg')
    fig_weights.savefig('param weights results 0 0_001 10000.jpg')
if args['num_exp']== 1:
    fig_error.savefig('param error results 0_01 0_001 10000.jpg')
    fig_weights.savefig('param weights results 0_01 0_001 10000.jpg')
if args['num_exp']== 2:
    fig_error.savefig('param error results 0_05 0_001 10000.jpg')
    fig_weights.savefig('param weights results 0_05 0_001 10000.jpg')
if args['num_exp']== 3:
    fig_error.savefig('param error results 0_1 0_001 10000.jpg')
    fig_weights.savefig('param weights results 0_1 0_001 10000.jpg') 
if args['num_exp']== 4:
    fig_error.savefig('param error results 0_15 0_001 10000.jpg')
    fig_weights.savefig('param weights results 0_15 0_001 10000.jpg') 
if args['num_exp']== 5:
    fig_error.savefig('param error results 0_2 0_001 10000.jpg')
    fig_weights.savefig('param weights results 0_2 0_001 10000.jpg') 
if args['num_exp']== 6:
    fig_error.savefig('param error results 0_25 0_001 10000.jpg')
    fig_weights.savefig('param weights results 0_25 0_001 10000.jpg')
if args['num_exp']== 7:
    fig_error.savefig('param error results 0_05 0_01 10000.jpg')
    fig_weights.savefig('param weights results 0_05 0_01 10000.jpg')
if args['num_exp']== 8:
    fig_error.savefig('param error results 0_05 0_1 10000.jpg')
    fig_weights.savefig('param weights results 0_05 0_1 10000.jpg')
if args['num_exp']== 9:
    fig_error.savefig('param error results 0_05 1 10000.jpg')
    fig_weights.savefig('param weights results 0_05 1 10000.jpg')
if args['num_exp']== 10:
    fig_error.savefig('param error results 0_05 100 10000.jpg')
    fig_weights.savefig('param weights results 0_05 100 10000.jpg')
if args['num_exp']== 11:
    fig_error.savefig('param error results 0_05 1000 10000.jpg')
    fig_weights.savefig('param weights results 0_05 1000 10000.jpg')
if args['num_exp']== 12:
    fig_error.savefig('param error results 0_05 10000 10000.jpg')
    fig_weights.savefig('param weights results 0_05 10000 10000.jpg')
if args['num_exp']== 13:
    fig_error.savefig('param error results 0_05 100000 10000.jpg')
    fig_weights.savefig('param weights results 0_05 100000 10000.jpg')
if args['num_exp']== 14:
    fig_error.savefig('param error results 0_05 1000000 10000.jpg')
    fig_weights.savefig('param weights results 0_05 1000000 10000.jpg')
if args['num_exp']== 15:
    fig_error.savefig('param error results 0_05 0_001 5000.jpg')
    fig_weights.savefig('param weights results 0_05 0_001 5000.jpg')
if args['num_exp']== 16:
    fig_error.savefig('param error results 0_05 0_001 15000.jpg')
    fig_weights.savefig('param weights results 0_05 0_001 15000.jpg')
